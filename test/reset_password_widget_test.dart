...
void main() {
  testWidgets('reset password widget test', (WidgetTester tester) async {
    ...
    var confirmedPassTextField =
        find.widgetWithText(TextField, "Confirmed password");
    ...
    expect(find.text("Hello1234"),
        findsAny); // because the user could actually reset his new password with his current password
